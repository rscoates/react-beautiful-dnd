	...
	*/
	...
	var Draggable = function (_Component) {
	  ...
	  function Draggable(props, context) {
	    ...
	    _this.getDraggingStyle = index$1(function (change, dimension, isDropAnimating, axisLock) {
	    ...
	    _this.getNotDraggingStyle = index$1(function (current, shouldAnimateDisplacement, axisLock) {
	      var style = {
	    ...
	    _this.getProvided = index$1(function (change, isDragging, isDropAnimating, shouldAnimateDisplacement, dimension, dragHandleProps, axisLock) {
