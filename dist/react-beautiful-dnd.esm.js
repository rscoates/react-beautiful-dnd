...
var getTranslate = function getTranslate(offset, axisLock) {
...
var Draggable = function (_Component) {
  ...
  function Draggable(props, context) {
    ...
    _this.getDraggingStyle = memoizeOne(function (change, dimension, isDropAnimating, axisLock) {
    ...
    _this.getNotDraggingStyle = memoizeOne(function (current, shouldAnimateDisplacement, axisLock) {
      var style = {
    ...
    _this.getProvided = memoizeOne(function (change, isDragging, isDropAnimating, shouldAnimateDisplacement, dimension, dragHandleProps, axisLock) {
      ...
      var draggableStyle = function () {
        ...
        return _this.getDraggingStyle(change, dimension, isDropAnimating, axisLock);
      }();
    ...
    _this.renderChildren = function (change, dragHandleProps) {
      var _this$props2 = _this.props,
          ...
          axisLock = _this$props2.axisLock;
      var child = children(_this.getProvided(change, isDragging, isDropAnimating, shouldAnimateDisplacement, dimension, dragHandleProps, axisLock), _this.getSnapshot(isDragging, isDropAnimating, draggingOver));
